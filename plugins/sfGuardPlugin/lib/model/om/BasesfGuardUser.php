...
abstract class BasesfGuardUser extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->email_address = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			...
			return $startcol + 13; // 13 = sfGuardUserPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(sfGuardUserPeer::EMAIL_ADDRESS)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL_ADDRESS`';
		}
		if ($this->isColumnModified(sfGuardUserPeer::BIRTHDAY)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setEmailAddress($arr[$keys[7]]);
