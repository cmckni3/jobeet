 ...
 * @method     sfGuardUserQuery orderByEmailAddress($order = Criteria::ASC) Order by the email_address column
 * @method     sfGuardUserQuery orderByBirthday($order = Criteria::ASC) Order by the birthday column
 ...
 * @method     sfGuardUserQuery groupByEmailAddress() Group by the email_address column
 * @method     sfGuardUserQuery groupByBirthday() Group by the birthday column
 ...
 * @method     sfGuardUser findOneByEmailAddress(string $email_address) Return the first sfGuardUser filtered by the email_address column
 * @method     sfGuardUser findOneByBirthday(string $birthday) Return the first sfGuardUser filtered by the birthday column
 ...
 * @method     array findByEmailAddress(string $email_address) Return sfGuardUser objects filtered by the email_address column
 * @method     array findByBirthday(string $birthday) Return sfGuardUser objects filtered by the birthday column
...
abstract class BasesfGuardUserQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID`, `USERNAME`, `ALGORITHM`, `SALT`, `PASSWORD`, `FIRST_NAME`, `LAST_NAME`, `EMAIL_ADDRESS`, `BIRTHDAY`, `CREATED_AT`, `LAST_LOGIN`, `IS_ACTIVE`, `IS_SUPER_ADMIN` FROM `sf_guard_user` WHERE `ID` = :p0';
		try {
	...
	public function filterByEmailAddress($emailAddress = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(sfGuardUserPeer::EMAIL_ADDRESS, $emailAddress, $comparison);
	}
	...
	public function filterByBirthday($birthday = null, $comparison = null)
	{
		if (is_array($birthday)) {
			...
			if (isset($birthday['min'])) {
				$this->addUsingAlias(sfGuardUserPeer::BIRTHDAY, $birthday['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($birthday['max'])) {
				$this->addUsingAlias(sfGuardUserPeer::BIRTHDAY, $birthday['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(sfGuardUserPeer::BIRTHDAY, $birthday, $comparison);
	}
