...
abstract class BaseJobeetCategoryAffiliate extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = JobeetCategoryAffiliatePeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = JobeetCategoryAffiliateQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(JobeetCategoryAffiliatePeer::CATEGORY_ID)) {
			$modifiedColumns[':p' . $index++]  = '`CATEGORY_ID`';
		}
		if ($this->isColumnModified(JobeetCategoryAffiliatePeer::AFFILIATE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`AFFILIATE_ID`';
		}

		$sql = sprintf(
			'INSERT INTO `jobeet_category_affiliate` (%s) VALUES (%s)',
	...
	{
		if (isset($alreadyDumpedObjects['JobeetCategoryAffiliate'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['JobeetCategoryAffiliate'][serialize($this->getPrimaryKey())] = true;
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->aJobeetAffiliate) {
				$result['JobeetAffiliate'] = $this->aJobeetAffiliate->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
			}
		}
		return $result;
	}
	...
	{
		return (null === $this->getCategoryId()) && (null === $this->getAffiliateId());
	}
	...
	public function getJobeetAffiliate(PropelPDO $con = null)
	{
		if ($this->aJobeetAffiliate === null && ($this->affiliate_id !== null)) {
			$this->aJobeetAffiliate = JobeetAffiliateQuery::create()->findPk($this->affiliate_id, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
	...
	{
		return (string) $this->exportTo(JobeetCategoryAffiliatePeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function __call($name, $params)
	{
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseJobeetCategoryAffiliate:' . $name))
		{
