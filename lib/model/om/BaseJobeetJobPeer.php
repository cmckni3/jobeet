...
abstract class BaseJobeetJobPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CATEGORY_ID', 'TYPE', 'COMPANY', 'LOGO', 'URL', 'POSITION', 'LOCATION', 'DESCRIPTION', 'HOW_TO_APPLY', 'TOKEN', 'IS_PUBLIC', 'IS_ACTIVATED', 'EMAIL', 'EXPIRES_AT', 'CREATED_AT', 'UPDATED_AT', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CATEGORY_ID' => 1, 'TYPE' => 2, 'COMPANY' => 3, 'LOGO' => 4, 'URL' => 5, 'POSITION' => 6, 'LOCATION' => 7, 'DESCRIPTION' => 8, 'HOW_TO_APPLY' => 9, 'TOKEN' => 10, 'IS_PUBLIC' => 11, 'IS_ACTIVATED' => 12, 'EMAIL' => 13, 'EXPIRES_AT' => 14, 'CREATED_AT' => 15, 'UPDATED_AT' => 16, ),
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (JobeetJob object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = JobeetJobPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = JobeetJobPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + JobeetJobPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = JobeetJobPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doSelectJoinJobeetCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		JobeetJobPeer::addSelectColumns($criteria);
		$startcol = JobeetJobPeer::NUM_HYDRATE_COLUMNS;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		JobeetJobPeer::addSelectColumns($criteria);
		$startcol2 = JobeetJobPeer::NUM_HYDRATE_COLUMNS;
	...
	/**
	 * Performs an INSERT on the database, given a JobeetJob or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a JobeetJob or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(JobeetJobPeer::ID);
			if ($value) {
				$selectCriteria->add(JobeetJobPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(JobeetJobPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the jobeet_job table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(JobeetJobPeer::TABLE_NAME, $con, JobeetJobPeer::DATABASE_NAME);
	...
	/**
	 * Performs a DELETE on the database, given a JobeetJob or Criteria object OR a primary key value.
	 *
